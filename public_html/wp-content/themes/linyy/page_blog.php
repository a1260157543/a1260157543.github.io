    ...
    <div class="padd-box clear-mrg">						
						<!-- START: PAGE CONTENT -->
						    <center><div class="pf-filter padd-box">
											<a class="btn btn-sh btn-success" href="?page_id=96" >全部</a>
											<a class="btn btn-sh btn-primary" href="?page_id=277" >用户体验</a>
...
<?php
	...
	query_posts('category_name=study&showposts=' . $limit=4 . '&paged=' . $paged);
